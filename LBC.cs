...
{
	public class LBC : NetworkSetBase
	{
		public static LBC Instance { get; } = new LBC();
...
#pragma warning disable CS0618 // Type or member is obsolete
		public class LBCConsensusFactory : ConsensusFactory
		{
			private LBCConsensusFactory()
			{
			}

			public static LBCConsensusFactory Instance { get; } = new LBCConsensusFactory();

			public override BlockHeader CreateBlockHeader()
			{
				return new LBCBlockHeader();
			}
			public override Block CreateBlock()
			{
				return new LBCBlock(new LBCBlockHeader());
			}
		}

		public class LBCBlockHeader : BlockHeader
		{
		...
		{
			public LBCBlock(LBCBlockHeader header) : base(header)
			{

			}
			public override ConsensusFactory GetConsensusFactory()
			{
				return LBCConsensusFactory.Instance;
			}
		}

		public class LBCMainnetAddressStringParser : NetworkStringParser
		{
...
#pragma warning restore CS0618 // Type or member is obsolete
		...
		{
			RegisterDefaultCookiePath("LBC", new FolderName() { TestnetFolder = "testnet4" });
		}
		...
		protected override NetworkBuilder CreateMainnet()
		{
			...
			builder.SetConsensus(new Consensus()
			{
				...
				LBCWorkCalculation = true,
				ConsensusFactory = LBCConsensusFactory.Instance
			})
			...
			.SetNetworkStringParser(new LBCMainnetAddressStringParser())
			...
			.AddAlias("lbc-mainnet")
			.AddAlias("lbc-main")
			.AddDNSSeeds(new[]
			{
				new DNSSeedData("loshan.co.uk", "seed-a.lbc.loshan.co.uk"),
				new DNSSeedData("thrasher.io", "dnsseed.thrasher.io"),
				new DNSSeedData("lbctools.com", "dnsseed.lbctools.com"),
				new DNSSeedData("lbcpool.org", "dnsseed.lbcpool.org"),
		...
		protected override NetworkBuilder CreateTestnet()
		{
			...
			.AddAlias("lbc-test")
			.AddAlias("lbc-testnet")
			.AddDNSSeeds(new[]
			{
				new DNSSeedData("lbctools.com", "testnet-seed.lbctools.com"),
				new DNSSeedData("loshan.co.uk", "seed-b.lbc.loshan.co.uk"),
